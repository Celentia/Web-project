...
var Motorola = new telephone('<img src="214404_gal.jpg" height = 20%>', 'Motorola Defy', 3.7, 2.5, 118);
var Philips = new telephone('<img src="hq.jpg" height = 23%>', 'Philips Xenium W6610', 5, 2, 115);
var Lenovo = new Laptop('<img src = "Lenovo.jpeg", width = 60px, height = 60px>', 'Lenovo', 22, 2, 2115);
var hp = new Laptop('<img src = "hp.jpeg", width = 60px, height = 60px>', 'hp', 21, 3, 1500);
var Ergo = new Tablet('<img src = "ergo.jpg", height = 18%>', 'Ergo Tab A720', 7, 2, 270);
var Pixus = new Tablet('<img src = "pixus.jpg", height = 10%>', 'Pixus Touch 7', 6.95, 3, 300);
